// src/pages/admin/orders/create/index.tsx
...
import { ArrowRight, ArrowLeft, Check, Package, MapPin, Ruler, CreditCard, User } from 'lucide-react';
...
const STEPS = [
  { label: 'Customer & Addresses', sub: 'Details & Locations', icon: MapPin },
...
export default function AdminCreateOrder() {
  ...
  return (
    <Box minH="100vh" bg={pageBg} pb={12} pt={6}>
              ...
              <VStack spacing={7} align="stretch">
                <Box>
                  <Flex align="center" gap={2} mb={4}>
                    <Box w={7} h={7} bg={useColorModeValue('orange.50', 'rgba(249,115,22,0.12)')} borderRadius="lg" display="flex" alignItems="center" justifyContent="center">
                      <User size={14} color="#F97316" strokeWidth={2.5} />
                    </Box>
                    <Text fontSize="sm" fontWeight="700" color={headClr}>Customer</Text>
                  </Flex>
                  <FormControl isRequired>
                    <FormLabel {...labelProps}>Select Customer</FormLabel>
                    <Select
                      name="customerId"
                      value={formData.customerId}
                      onChange={handleInputChange}
                      placeholder={isFetchingCustomers ? 'Loading...' : 'Select a customer'}
                ...
                <Flex justify="flex-end" pt={2}>
                  <Button
                    ...
                    onClick={goToNext}
                    isDisabled={!formData.customerId || !formData.pickupAddress || !formData.dropAddress || !formData.pickupPincode || !formData.dropPincode}
                    bg="brand.500"
                    color="white"
                    _hover={{ bg: 'brand.600' }}
                    borderRadius="xl"
            ...
            {activeStep === 2 && pricing && (
              <VStack spacing={6} align="stretch">
                <Box>
                  ...
                  <Text fontSize="xs" color={subClr}>Review the charges before confirming the order.</Text>
                </Box>
